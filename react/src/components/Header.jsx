         ...
         <div className="flex items-center gap-4">
            <a href="#" className="block focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded"
               ...
               <svg xmlns="http://www.w3.org/2000/svg"
                  ...
                  aria-hidden="true" viewBox="0 0 155.139 155.139">
                  <path
            ...
            <a href="#" className="block focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded"
               ...
               <svg xmlns="http://www.w3.org/2000/svg"
                  className="size-4 fill-slate-900 hover:fill-blue-700 dark:hover:fill-blue-400 dark:fill-slate-300 transition"
                  aria-hidden="true" viewBox="0 0 1226.37 1226.37">
                  <path
   ...
   <nav
      ...
      <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-4 w-full">
         ...
         <div id="collapseMenu" tabindex="-1"
            ...
            <ul
               className="flex flex-col gap-8 font-semibold text-sm text-slate-900 dark:text-slate-50 lg:flex-row max-lg:p-6">
               <li>
                  <a href="#"
